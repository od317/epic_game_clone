    ...
    <div class="w-[78%]
       ...
       md:w-[100%]">
        ...
        <div class=" flex   flex-row w-[400%]">
                  ...
                  <div v-for="gl in gamelist" :class="`flex  justify-between w-full  h-fit translate-x-[-100%] transition-all duration-500`">
                  ...
                  <div v-for="gl in gamelist" :class="`flex  justify-between w-full  h-fit translate-x-[-200%] transition-all duration-500`">
            ...
            <div :class="`${game.last? 'w-full h-full':'hidden '} relative flex justify-center items-center`">
             ...
             <div class="absolute h-full w-full bg-black opacity-50"></div>
                  ...
                  <div v-for="gl in gamelist" :class="`flex  justify-between w-full  h-fit translate-x-[-300%] transition-all duration-500`">
                  ...
                  <div v-for="gl in gamelist" :class="`flex  justify-between w-full  h-fit translate-x-[-400%] transition-all duration-500`">
                  ...
                  <div v-for="gl in gamelist" :class="`flex  justify-between w-full  h-fit translate-x-[-500%] transition-all duration-500`">
                      
                                
                 

                  </div>
                  <div v-for="gl in gamelist" :class="`flex  justify-between w-full  h-fit translate-x-[-600%] transition-all duration-500`">
                      
                                
                 

                    </div>
                    <div v-for="gl in gamelist" :class="`flex  justify-between w-full  h-fit translate-x-[-700%] transition-all duration-500`">
                      
                                
                 

                    </div>
                    <div v-for="gl in gamelist" :class="`flex  justify-between w-full  h-fit translate-x-[-800%] transition-all duration-500`">
                      
                                
                 

                    </div>
                    <div v-for="gl in gamelist" :class="`flex  justify-between w-full  h-fit translate-x-[-900%] transition-all duration-500`"></div>
                    ...
                    <div v-for="gl in gamelist" :class="`flex  justify-between w-full  h-fit translate-x-[-1200%] transition-all duration-500`"></div>
                     ...
                     <button class="bg-[#660404]">ss</button>
                     <button class="bg-[#2ab1eb]">ss</button>
                     <button class="bg-[#db0d4e]">ss</button>
                     <button class="bg-[#2a70d1]">ss</button>
                     <button class="bg-[#de9312]">ss</button>
