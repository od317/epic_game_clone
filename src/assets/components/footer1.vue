...
<template>
        ...
        <div class="flex w-full justify-center mb-[4rem]">
               <div class="flex p-[1rem] w-[78%] ">
                      ...
                      <div class=" w-[100%] p-2 flex flex-col justify-center ml-5 ">
                        ...
                        <button class="text-black bg-white w-[40%] mt-[2rem] p-[1rem] rounded-lg">Browse All</button>
                      </div>
               </div>
        </div>
