...
<template>
   <div class="hidden w-screen md:flex items-center justify-center mb-[3rem] mt-[5rem]">
    ...
    <div v-if = "game_an.length==3" :class="`grid w-[78%]  grid-cols-3 grid-rows-1 gap-[2rem]`">
            ...
            <div @Click="router_push(ga.type,ga.dst)" v-for="ga in game_an" class="flex flex-col cursor-pointer">
                <img :src="ga.img" alt="" class="rounded-2xl cursor-pointer hover:opacity-50 transition-all duration-150 ">
                <div class="p-4 flex flex-col w-full cursor-pointer">
                    ...
                    <label for="" class="text-white mt-[2rem] text-lg cursor-pointer">save now</label>
      ...
      <div v-else  :class="`grid w-[78%]  grid-cols-2 grid-rows-1 gap-[2rem]`">
            ...
            <div @Click="router_push(ga.type,ga.dst)" v-for="ga in game_an" class="flex flex-col cursor-pointer">
                ...
                <div class="p-4 flex flex-col w-full cursor-pointer">
                    ...
                    <label for="" class="text-white  text-lg cursor-pointer">{{ ga.down_text }}</label>
